...
/**
 * This file was generated via php core/scripts/generate-proxy-class.php 'Drupal\webprofiler\Command\ListCommand' "modules/contrib/devel/webprofiler/src".
 */
...
namespace Drupal\webprofiler\ProxyClass\Command {
    ...
    class ListCommand
    {
        ...
        {
            return $this->lazyLoadItself()->addArgument($name, $mode, $description, $default);
        }
        ...
        {
            return $this->lazyLoadItself()->addOption($name, $shortcut, $mode, $description, $default);
        }
